...
perl ./DNA_bed2-1Mb_wheat_CSGL.pl ./output_MEME-3.bed output_MEME-3.Mb.txt"


#####06_Non-B form DNA
Whole genome Non-B form DNA sourced from Ma et al 2022

####Centromere random
samtools faidx wheat.CSGL.fa  > wheat.CSGL.fai
bedtools makewindows -g wheat.CSGL.fai -w 10000 > 10Kb_windows.bed
bedtools intersect -a ./CS_CEN.bed -b ./10Kb_windows.bed > CS_CEN_10kb.bed
bedtools intersect -a ./CS_Arm.bed -b ./10Kb_windows.bed > CS_Arm_10kb.bed

######Centromere random NONBDNA
shuf -n 500 ./CS_CEN_10kb.bed | bedtools intersect -v -a - -b ./BreakPoint_10kb.bed | shuf -n 200 > CEN_random_200_10kb.bed;
sort -k1,1 -k2,2n CEN_random_200_10kb.bed > sorted_CEN_random_200_10kb.bed;
bedtools intersect -a ./sorted_CEN_random_200_10kb.bed -b ./wheat.CSGL.APR-DR-MR.bed  -wao > CENrandom_200_10kb_APR-DR-MR.txt

#BreakPoint_10kb_APR-DR-MR
bedtools intersect -a ./BreakPoint_10kb.bed -b ./wheat.CSGL.APR-DR-MR.bed  -wao > BreakPoint_10kb_APR-DR-MR.txt

##########Chromosome arm random
shuf -n 500 ./CS_Arm_10kb.bed | bedtools intersect -v -a - -b ./BreakPoint_10kb.bed | shuf -n 200 > Arm_random_200_10kb.bed
sort -k1,1 -k2,2n Arm_random_200_10kb.bed > sorted_Arm_random_200_10kb.bed
